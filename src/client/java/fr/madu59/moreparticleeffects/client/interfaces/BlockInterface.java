...
public interface BlockInterface {
    ...
    void onTill(LevelAccessor level, Block oldBlock, Block newBlock);
    void onStrip(LevelAccessor level, Block oldBlock, Block newBlock);
    void onFlatten(LevelAccessor level, Block oldBlock, Block newBlock);
    ...
    void onBlockChange(LevelAccessor level, Block oldBlock, Block newBlock);
}
